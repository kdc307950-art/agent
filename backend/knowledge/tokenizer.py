...
_IT_TERMS = (
    "VPN", "SSO", "MFA", "Outlook", "IMAP", "SMTP", "Wi-Fi", "IPsec",
    "错误码 769", "错误码 809", "企业微信", "钉钉", "打印机", "软件中心",
    "权限申请", "备用机", "远程办公", "无法连接", "办公网络", "邮箱容量",
    "共享打印机", "管理员权限", "账号锁定", "重置密码", "忘记密码",
    "收不到邮件", "断网", "开机", "排查", "离线", "报修", "卡纸", "硒鼓",
    "驱动", "许可证", "审批", "开通", "开不了机", "转圈", "登不进去",
    "区域故障", "驱动站", "重启", "报错", "指示灯",
)
...
_STOPWORDS = frozenset(
    "的了吗呢吧啊呀哦么一个是我你他她它们就都还很太更最"
)
_STOP_PHRASES = frozenset(
    ("怎么", "什么", "怎样", "如何", "怎么办", "为什么", "有没有", "不会", "需要", "请问", "一下", "时候", "是否")
)
